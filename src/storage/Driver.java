...
/**
 * This is a driver to help set up a sample database. This can be used to reset
 * or remake the database since the JUnit testing can't make any permanent
 * changes to the database (or else the test results will not be consistent).
 *
 * Not actually needed in the program.
 *
 * @author Josh Wright Created: Jan 28, 2014 Package: backend
 *
 */
public class Driver {
