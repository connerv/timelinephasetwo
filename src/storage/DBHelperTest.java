 ...
 * DBHelperTest.java
 *
 * @author Josh Wright Created: Feb 14, 2014 Package: database
 *
 * The tests are a little on the simple side, but the tests are made to allow
 * for straightforward implementation, and it is difficult to make sure the
 * database is setup properly for each test (since the data in the database
 * lasts after the tests are finished).
 *
 * At the time of writing this, all the tests pass. If for some reason they
 * don't, try deleting the helpertest.db database in the databases directory.
 *
 */
public class DBHelperTest {
    ...
    /**
     * Test method for
     * {@link database.DBHelper#changeTimeline(entities.Timeline, entities.Timeline)}.
     * Make sure that the changeTimeline method swaps both the timelines (names
     * and events).
     */
    @Test
    ...
    /**
     * Test method for
     * {@link database.DBHelper#writeTimeline(entities.Timeline)}. Make sure
     * that the writeTimeline method writes both the names and events of the
     * timeline.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link database.DBHelper#removeTimeline(entities.Timeline)}. Make sure
     * that the removeTimeline method removes the timeline from the database.
     */
    @Test
    ...
    /**
     * Test method for {@link database.DBHelper#getTimelines()}. Make sure that
     * the getTimelines method gets all the timelines in the database, including
     * their names and events.
     */
    @Test
