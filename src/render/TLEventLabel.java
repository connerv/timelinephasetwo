 ...
 * Currently the subclasses have a decent amount of repetition so some of that
 * could be moved up here.
 *
 * @author Josh Wright Created: February 15, 2014 Last Edited: March 15, 2014
 *
...
public abstract class TLEventLabel extends Label {
    ...
    /**
     * Setter for selected, that updates the label in accordance with the
     * selection value
     *
     * @param selected
     */
