 ...
 *
 * Various online examples of the Calendar class as well as making javafx
 * graphics were used in the making this class.
 */
public class TimelineRender extends Pane {
     ...
     *
     * @param i the number of units after the first unit on the axis (the 'x'
     * coordinate in AxisLabel units)
     * @param xPos2 the actual pixel starting x coordinate of the label on the
     * scene
     ...
     *
     * i.e. if the first date was November 3, 2012, this would return January 1,
     * 2012.
     */
