...
public class Atomic extends TLEvent {
    ...
    /**
     * There is nothing special about Atomic events right now. To put anything
     * else in this class apart from what's in TLEvent would be redundant. We
     * may choose to put an icon here.
     *
     * @param name
     * @param category
     * @param startDate
